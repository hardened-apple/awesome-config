...
tilegaps.name = "tilegaps"
tilegaps.arrange = tile

--- The main tile algo, on left.
-- @param screen The screen number to tile.
tilegaps.left = {}
tilegaps.left.name = "tileleftgaps"
function tilegaps.left.arrange(p)
    return tile(p, "left")
end
...
-- @param screen The screen number to tile.
tilegaps.bottom = {}
tilegaps.bottom.name = "tilebottomgaps"
function tilegaps.bottom.arrange(p)
...
-- @param screen The screen number to tile.
tilegaps.top = {}
tilegaps.top.name = "tiletopgaps"
function tilegaps.top.arrange(p)
    return tile(p, "top")
end
