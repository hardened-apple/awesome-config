...
-- Date widget to test
-- Note that this does not work - has the same error as smallcross
--local date = require("mattswidget.date")

--###################### Attempt at including smallcross from other file
--local smallcross = require("mattswidget.smallcross")
...
tags = {
    ...
    layout = { layouts[2], layouts[1], layouts[1], layouts[2], layouts[2], layouts[2], layouts[7], layouts[2], layouts[7] }
}
for s = 1, screen.count() do
